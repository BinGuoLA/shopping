		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					<div class="col-md-6">
						<img style="opacity: 1;width:400px;height:350px;" title="" class="medium" src="${pageContext.request.contextPath}/${productInfo.pimage}">
					</div>
					...
					<div class="col-md-6">
						...
						<div style="margin:10px 0 10px 0;">商城价: <strong style="color:#ef0101;">￥：${productInfo.shop_price} </strong> 参 考 价： <del>${productInfo.market_price}</del>
						</div>
